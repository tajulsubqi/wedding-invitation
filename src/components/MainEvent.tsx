  ...
  return (
    <>
      <div className="py-5 bg-gray-200">
        <h2 className="font-secondary text-4xl text-center my-6">Informasi Acara</h2>
        <div className="flex flex-wrap justify-around items-center p-8 gap-6">
          ...
          >
            ...
            <p className="text-base font-semibold py-4 text-center">08:00 - 10:00</p>
            <p className="text-xl font-bold text-center">Kediaman mempelai Pria</p>
          ...
          >
            ...
            <p className="text-base font-semibold py-4 text-center">09:00 - 15:00</p>
            <p className="text-xl font-bold text-center">Kediaman mempelai Wanita</p>
            <p className="text-lg font-semibold textr-center mb-3">
